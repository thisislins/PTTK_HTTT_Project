...
CREATE TABLE SO_TIEM_CHUNG (
	...
	PHANUNG NVARCHAR(50),
	MAKH INT,
	PRIMARY KEY(NGAYTIEM, MAVC, MAKH)
)
------ADD FOREIGN KEY
...
ALTER TABLE HOA_DON
ADD CHECK (PHUONGTHUCTT IN (N'THANH TOÁN 1 LẦN', N'THANH TOÁN CHUYỂN KHOẢN'))

ALTER TABLE HOA_DON
ADD CHECK (HINHTHUCTT IN (N'THANH TOÁN BẰNG THẺ', N'THANH TOÁN BẰNG TIỀN MẶT'))

ALTER TABLE PHIEU_DANG_KY
ADD CHECK (TRANGTHAI IN (N'CHƯA TIÊM', N'ĐÃ TIÊM'))

ALTER TABLE PHIEU_DANG_KY
ADD CHECK (TRANGTHAITT IN (N'CHƯA THANH TOÁN ĐỦ', N'ĐÃ THANH TOÁN ĐỦ'))
